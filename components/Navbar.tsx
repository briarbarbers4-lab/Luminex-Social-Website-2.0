...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-[#0B0E14]/95 backdrop-blur-sm border-b border-[#334155]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link href="#work" className="text-[#F8FAFC] hover:text-[#6366F1] transition-colors font-mono text-sm">
            Work
          </Link>
          <Link href="#services" className="text-[#F8FAFC] hover:text-[#6366F1] transition-colors font-mono text-sm">
            Services
          </Link>
          <Link href="#process" className="text-[#F8FAFC] hover:text-[#6366F1] transition-colors font-mono text-sm">
            Process
          </Link>
          <Link href="#testimonials" className="text-[#F8FAFC] hover:text-[#6366F1] transition-colors font-mono text-sm">
            Testimonials
          </Link>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-[#1E293B] border-t border-[#334155]">
          <div className="flex flex-col gap-4 px-4 py-4">
            <Link href="#work" className="text-[#F8FAFC] hover:text-[#6366F1] transition-colors">
              Work
            </Link>
            <Link href="#services" className="text-[#F8FAFC] hover:text-[#6366F1] transition-colors">
              Services
            </Link>
            <Link href="#process" className="text-[#F8FAFC] hover:text-[#6366F1] transition-colors">
              Process
            </Link>
            <Link href="#testimonials" className="text-[#F8FAFC] hover:text-[#6366F1] transition-colors">
              Testimonials
            </Link>

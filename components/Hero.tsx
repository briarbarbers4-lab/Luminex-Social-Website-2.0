  ...
  return (
    <section className="relative min-h-screen flex items-center bg-[#0B0E14] overflow-hidden">
      ...
      <div className="relative z-10 w-full lg:w-1/2 px-6 md:px-12 lg:px-16 py-20 pt-32">
        ...
        >
          <span className="font-mono text-[#F8FAFC] text-xs md:text-sm tracking-wide">
        ...
        {/* Headline */}
        <h1 
          className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-[#F8FAFC] mb-6 text-left"
          style={{ 
        ...
        >
          <span className="block">Build Your Market</span>
          <span className="block">Dominance Every</span>
          <span className="block">Single Month Through</span>
          <span className="block">Our{' '}
            <span 
        ...
        {/* Sub-headline */}
        <p 
          className="text-base md:text-lg lg:text-xl text-left max-w-xl mb-10"
          style={{ 
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-start">
          {/* Book A Call - Gradient with glow */}
          <button 
            className="px-8 py-4 rounded-lg text-[#F8FAFC] font-semibold text-base md:text-lg transition-all transform hover:scale-105"
            style={{
              background: 'linear-gradient(to right, #6366F1, #A855F7)',
              boxShadow: '0 0 20px rgba(99, 102, 241, 0.4), 0 0 40px rgba(168, 85, 247, 0.25)',
            }}
          >
            Book A Call
          </button>
          ...
          <button 
            className="flex items-center gap-2 px-8 py-4 rounded-lg bg-transparent text-[#F8FAFC] font-semibold text-base md:text-lg transition-all hover:bg-[#1E293B]/50"
        ...
        >
          <div className="max-w-7xl mx-auto px-6 md:px-12">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 font-mono text-sm">
              ...
              <span className="text-[#6366F1] hidden sm:inline">//</span>
              <span className="text-[#F8FAFC]">
